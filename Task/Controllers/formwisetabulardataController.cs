...
{
    public class formwisetabulardataController : ApiController
    {
        ...
        // GET api/formwisetabulardata
        public IEnumerable<string> Get()
        {
            return new string[] { "value1", "value2" };
        }

        // GET api/formwisetabulardata/5
        public string Get(string id)
        {
            Hashtable hs = new Hashtable();
            hs.Add("@QType", "ReportTabBYfORM");
            hs.Add("@formid", id);
        ...
        // POST api/formwisetabulardata
        public void Post([FromBody]string value)
        {
        }

        // PUT api/formwisetabulardata/5
        public void Put(int id, [FromBody]string value)
        {
        }

        // DELETE api/formwisetabulardata/5
